...
/// Shows a bottom sheet for editing client data
void showEditClientBottomSheet(
  ...
  final latitudeController = TextEditingController(text: client.latitude ?? '');
  final locationCoordinatesController = TextEditingController(
    text:
        (client.latitude != null && client.longitude != null)
            ? 'Lat: ${double.tryParse(client.latitude ?? '')?.toStringAsFixed(6) ?? client.latitude}, Lng: ${double.tryParse(client.longitude ?? '')?.toStringAsFixed(6) ?? client.longitude}'
            : '',
  );
  // String selectedStatus = client.status ?? 'inactive';
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          cubit.updateClient(client.id!, request);
